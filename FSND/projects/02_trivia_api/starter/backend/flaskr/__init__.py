...
def create_app(test_config=None):
  ...
  def after_request(response):
    response.header.add('Access-Control-Allow-Header', 
  ...
  def add_question():
    ...
    if not ('quesion' in body and 'answer' in body and 'difficulty' in body and 'category' in body):
      abort(422)
  ...
  @app.route('/categories/<int:caetgory_id>/questions', methods = ['GET'])
